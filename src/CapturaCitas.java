...
public class CapturaCitas {
    ...
    public static void ValidaUsuario() {
        ...
        try{
            ...
            sMensajeUsuario = Users.Valida(sUsuario, sPassword);
            if (sMensajeUsuario == "") {
    ...
    private static void MuestraMenuAplicacion(){
        ...
        try {
            do{
                ...
                switch (sOpcionCitas) {
                    case "1":
                        Pacientes.MuestraMenuPacientes();
                        break;
                    case "2":
                        Doctores.MuestraMenuDoctores();
                        break;
                    case "3":
                        Citas.MuestraMenuCitas();
                        break;
                    case "4":
                        Users.MuestraMenuUsuarios();
                        break;
                    case "X":
